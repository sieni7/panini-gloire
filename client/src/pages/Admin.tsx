    ...
    <main className="admin-page">
      ...
      <div className="admin-layout">
        <aside className="admin-sidebar">
          ...
          <button className={active === "site" ? "admin-nav active" : "admin-nav"} onClick={() => setActive("site")}><Settings2 size={18} /> Informations du site</button><button className={active === "documentation" ? "admin-nav active" : "admin-nav"} onClick={() => setActive("documentation")}><BookOpen size={18} /> Documentation</button>
